    ...
    return (
        <div>
            <div className="card card-side bg-base-100 shadow-xl">
                <figure><img className=" md:max-h-[300px]" src={photo} alt="Movie" /></figure>
                <div className="card-body justify-center space-y-3">
                    ...
                    <div className="card-actions">
                        <Link to={`/items/${_id}`} onClick={() => handleDetails(_id)} className="btn bg-orange-500 text-white w-full">View Details</Link>
                    </div>
                </div>
            </div>
        </div>
