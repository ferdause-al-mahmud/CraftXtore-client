...
const Footer = () => {
    return (
        <footer className="mt-10 p-10 bg-base-300 text-base-content">
            <div className="footer max-w-[1170px] mx-auto">
                <nav>
                    <h2 className=" font-semibold text-[16px] md:text-xl">Craft<span className="text-orange-500">X</span>tore</h2>
            ...
            <div className="flex flex-col gap-8 items-center  mt-8">
                <div className="border-b border-gray-400 w-[200px] md:w-[300px] lg:w-[600px] mx-auto"></div>
                <p className="bg-base-300 text-base-content">Copyright © 2024 - All right reserved by CraftXtore</p>
            </div>
        </footer>
    );
};
